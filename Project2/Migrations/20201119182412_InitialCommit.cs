        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Attrition = table.Column<string>(fixedLength: true, maxLength: 10, nullable: false),
                    BusinessTravel = table.Column<string>(maxLength: 50, nullable: false),
                    ...
                    EducationField = table.Column<string>(maxLength: 50, nullable: false),
                    EmployeeCount = table.Column<int>(nullable: false),
                    EnvironmentSatisfaction = table.Column<int>(nullable: false),
                    Gender = table.Column<string>(fixedLength: true, maxLength: 10, nullable: false),
                    ...
                    JobRole = table.Column<string>(maxLength: 50, nullable: false),
                    JobSatisfaction = table.Column<int>(nullable: false),
                    MaritalStatus = table.Column<string>(fixedLength: true, maxLength: 10, nullable: false),
                    ...
                    Over18 = table.Column<string>(fixedLength: true, maxLength: 10, nullable: false),
                    OverTime = table.Column<string>(fixedLength: true, maxLength: 10, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeInfo", x => x.EmployeeNumber);
                });
